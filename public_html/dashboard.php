	...
	<div class="search" id="">
		<div class="wrapper">
			...
			<div class="search-container">
				<form>
					<input id="firstNameSearch" onkeyup="SearchContacts()" type="text" class="first-name" placeholder="First Name">
					<input id="lastNameSearch" onchange="SearchContacts()" type="text" class="last-name" placeholder="Last Name">
					<input id="emailSearch" onchange="SearchContacts()" type="text" class="email" placeholder="Email">
					<input id="phoneSearch" onchange="SearchContacts()" type="text" class=" phone-number" placeholder="Phone Number">
